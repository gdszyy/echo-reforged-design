...
*   所有存活的敌人根据其预设的“行动意图”（会在其头顶显示图标，如剑、盾、魔法杖）依次行动。
*   行动方式包括：直接攻击玩家、自我强化、治疗同伴、改变战场环境（如制造障碍物）等。
...
4.  **瞄准辅助**: 游戏是否提供弹道预测线？预测的精确度如何？这会极大影响游戏的操作门槛。

接下来，我希望能与您一同探讨这些开放问题，以完善战斗框架的最后细节。
